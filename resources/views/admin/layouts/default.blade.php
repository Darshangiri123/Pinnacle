...
>
  <head>
    ...
    <script src="{{ asset('assets2/vendor/js/dashboard-analytics.js') }}"></script>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a class="navbar-brand  fs-4 fw-bolder fst-italic text-primary" href="{{ route("front.home") }}">Pinnacle Admin</a>
          ...
          <ul class="menu-inner py-1 text-primary">
            <!-- Dashboard -->
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{ route('admin.groupuser.list') }}" class="menu-link">
                    <div data-i18n="Without menu">User groups List</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle text-primary">
                ...
                <div data-i18n="Account Settings">Groups</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('admin.group.list') }}" class="menu-link ">
                    <div data-i18n="Account">Group List</div>
                  </a>
                </li>
              </ul>   
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle text-primary">
                ...
                <div data-i18n="Authentications">Post</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="auth-register-basic.html" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Sub Field 2</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="auth-forgot-password-basic.html" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Sub Field 3</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle text-primary">
                <link rel="icon" type="image/png" href="{{ asset('images/communityicon.png') }}">
                <div data-i18n="Misc">Community</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="pages-misc-error.html" class="menu-link">
                    <div data-i18n="Error">Sub Field 1</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="pages-misc-under-maintenance.html" class="menu-link">
                    <div data-i18n="Under Maintenance">Sub Field 2</div>
                  </a>
                </li>
              </ul>
            </li>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="fs-5 bg-warning bg-gradient">Place the footer here</div>
